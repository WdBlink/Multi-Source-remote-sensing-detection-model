...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/wdblink/github/multispectral-object-detection/runs/train/exp28/weights/part_of_training.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='./data/multispectral/tree_dsm.yaml', help='*.data path')
